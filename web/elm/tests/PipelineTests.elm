    ...
    describe "Pipeline"
        ...
        , describe "update" <|
            ...
            , describe "top bar star icon" <|
                ...
                [ defineHoverBehaviour
                    { name = "star icon"
                    , setup = givenFavoritedPipelinesFetched |> Tuple.first
                    , query =
                        queryView
                    ...
                    , hoverable = Message.Message.TopBarFavoritedIcon 0
                    }
                , test "favoriting icon has click handler" <|
                    \_ ->
                        givenFavoritedPipelinesFetched
                            ...
                            |> Event.expect favMsg
                , test "click has FavoritedPipline effect" <|
                    \_ ->
                        givenFavoritedPipelinesFetched
                            |> Tuple.first
                            |> Common.queryView
                ...
                , test "clicking favorited icon fills the star" <|
                    \_ ->
                        Tuple.first
                            |> Application.update
                                (Msgs.Update <|
